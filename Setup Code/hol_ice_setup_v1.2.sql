...
/* ---------------------------------------------------------------------------
First we configure the roles and other objects needed for the lab
----------------------------------------------------------------------------*/
...
/*------------------------------------------------------------
Next we will load data into Snowflaek from a public S3 bucket
Customer and Policies data are loaded into SNowflaketo simulate 
internal data sets
----------------------------------------------------------------*/
...
CREATE OR REPLACE TABLE CUSTOMER (
 ...
 COPY INTO CUSTOMER FROM @HOL_DATA/customer/ FILE_FORMAT = (TYPE = PARQUET)
